...
Required only for `Records.R`
 ...
 - Raster files from [WorldClim Database ](http://www.worldclim.org/) in `.bil` format in a directory named "rasters".
...
Latitude: -49,55
 ...
 ![CleanMaps](http://i.imgur.com/GE1XrMA.png)
...
![Rarf.R](http://i.imgur.com/xgnDvuX.png)
 ...
 ![RarfMaps](http://i.imgur.com/LN3jVSN.png)
...
![Pseudomaps](http://i.imgur.com/exazFUb.png)
...
![MaxentOutput](http://i.imgur.com/GG8o6AJ.png)
...
![MAxentModel](http://i.imgur.com/3KU2bTJ.png)
...
![MaxentPred](http://i.imgur.com/OBrpbnR.png)
